...
void SavePrefs(void)
{
	...
	fprintf(f,
		...
		"# frameskip 0\n"
		"#\n"
		"# The screen size the Mac starts in, written as a desktop Basilisk II\n"
		"# writes it; 0 is the display's own width or height. From System 7.5\n"
		"# on, the Mac remembers what its Monitors control panel chose and\n"
		"# switches to it as it starts. The display's own size is offered too.\n"
		"# screen win/1280/720\n"
		"#\n"
		"# What your pointing device reports per inch. Left alone, a Macintosh\n"
		"# assumes 200 — the resolution of an ADB mouse, which it cannot learn\n"
		"# any other way — so a modern mouse at 1000 or 1600 is accelerated as\n"
