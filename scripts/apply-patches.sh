...
#
# AGENTS.md says never to edit external/ by hand. This is how the exceptions
# get in: patches/macemu/*.patch, each minimal, each explaining itself in its
# own header, each a candidate to send upstream.
#
...
PATCHES="${REPO_ROOT}/patches/macemu"
TARGET="${REPO_ROOT}/external/macemu"
